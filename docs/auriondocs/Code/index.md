...
- **Files processed:** 99
- **Lines of code:** 15,146
- **Symbols documented:** 341
- **Validation retries:** 38
...
- [UpdateProgressDialog](src/EchoHub.Client/UI/Dialogs/UpdateProgressDialog.cs.md)
...
- [FileValidationHelper](src/EchoHub.Server/Services/FileValidationHelper.cs.md)
- [ImageToAsciiService](src/EchoHub.Server/Services/ImageToAsciiService.cs.md)
